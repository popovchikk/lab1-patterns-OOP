...
# суть: добавление функций объекту без изменения его класса
# (молоко + сахар + сливки) - каждая добавка это декоратор
# +: можно комбинировать декораторы в любом порядке, создавая разные конфигурации
